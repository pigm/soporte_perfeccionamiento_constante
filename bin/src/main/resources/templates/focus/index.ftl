...
<div class="container px-3">
    <div class="row">
        ...
        <!-- Contenido celular -->
        <div class="col-12 vis-cel">

            <div class="row vis-cel mt-3 mb-3">
                <div class="col-8 px-0">
                    <h3>Focos</h3>
                </div>
                <div class="col-4 px-0">
            ...
            <div class="row">
                <div class="col-12 px-0 mt-2 table-responsive-sm">
                    <table class="table mine table-hover table-bordered table-sm table-responsive-sm">
                        <thead>
                            <tr>
                                <th scope="col" width="24%">Foco</th>
                                <th scope="col">Creado</th>
                        ...
                        <tbody class=" table-sm">
                            <tr>
                                <td><a href="#">Nombre del foco</a></td>
                                <td>DD/MM/AAAA</td>
                                <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae officiis ratione
                                    inventore odio pariatur.</td>
                                <td>5 acciones </td>
                            </tr>
                            <tr>
                                <td><a href="#">Nombre del foco</a></td>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
                            ...
                            <div class="form-row bg-agregar p-2 pb-3 accion">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="foco-accion-nombre" class="form-control foco-accion-nombre" aria-describedby="nombreAccionMejora"
                                            placeholder="Ingresa nombre de acción de mejora">
                                    </div>
                                </div>
                                <div class="col-12">
            ...
            <div class="modal-footer">
                <a href="#" class="footer-switch text-danger fon-14 remove-foco" data-original-title="Seguro que quieres <br> eliminar esta foco">
