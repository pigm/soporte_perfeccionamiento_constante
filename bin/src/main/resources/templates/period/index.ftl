...
<div class="container px-3">
    <div class="row">
        ...
        <div id="withoutPeriod" class="col-md-9">
            ...
            <!-- Contenido escritorio-->
            <div id="withoutPeriod-step2" class="col-md-12 vis-des">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-body row">
                            <div class="col-4 ">
                                <div>
                                    ...
                                    <input type="date" class="form-control" id="fecha-inicio-regional"
                                        name="fecha-inicio">
                ...
                <div class="col-12 mt-4 px-0">
                    ...
                    <button class="btn btn-secondary float-right mr-4">Cancelar</button>
                </div>
            </div>
        </div>

        <div id="withPeriod" class="col-md-9">
