    ...
    <div class="col-12 px-0">
        <div class="card mt-2">
            ...
            <div class="card-body row">
                ...
                <div class="col-6">
                    <button class="btn btn-secondary btn-sm float-right create-special-case" data-modulo="Documentos regionales" data-moduloId="0">Crear caso especial</button>
                </div>
    ...
    <div class="col-12 px-0 mt-4">
        <div class="card mt-2">
            ...
            <div class="card-body row">
                ...
                <div class="col-6">
                    <button class="btn btn-secondary btn-sm float-right create-special-case" data-modulo="Documentos provinciales" data-moduloId="1">Crear caso especial</button>
                </div>
    ...
    <div class="col-12 px-0 mt-4">
        <div class="card mt-2">
            ...
            <div class="card-body row">
                ...
                <div class="col-6">
                    <button class="btn btn-secondary btn-sm float-right create-special-case" data-modulo="Conformación de redes" data-moduloId="2">Crear caso especial</button>
                </div>
    ...
    <div class="col-12 px-0 mt-4">
        <div class="card mt-2">
            ...
            <div class="card-body row">
                ...
                <div class="col-6">
                    <button class="btn btn-secondary btn-sm float-right create-special-case" data-modulo="Asignación de supervisores" data-moduloId="3">Crear caso especial</button>
                </div>
    ...
    <div class="col-12 px-0 mt-4">
        <div class="card mt-2">
            ...
            <div class="card-body row">
                ...
                <div class="col-6">
                    <button class="btn btn-secondary btn-sm float-right create-special-case" data-modulo="Planificación e implemetanción del apoyo" data-moduloId="4">Crear caso especial</button>
                </div>
