...
public class PeriodoPlanificacionImplementacionApoyoDTO implements DTOEntity, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7510115755135774897L;
	...
	public String toString() {
		return "PeriodoPlanificacionImplementacionApoyoDTO [idPeriodoPlanificacionImplementacionApoyo="
				+ idPeriodoPlanificacionImplementacionApoyo + ", idPeriodo=" + idPeriodo + ", fechaRegistro="
