...
came.menu.proceso = (function () {
    ...
    function configureSubMenu() {
        var menuproceso = $("#menuproceso");
        var menuPso = came.storage.getSessionStorage('menu');
        console.log(menuPso);
        if (menuPso) {
            var subMenuproceso = menuPso.find(e => e.idModule == '2416198290916770826');
            console.log(subMenuproceso.subMenu);
            subMenuproceso.subMenu.forEach(m => {
                console.log(m.name);
    ...
    function init() {
        console.log('came.menu.proceso.init');
        configureSubMenu();
        // getCurrentPath();
    }
