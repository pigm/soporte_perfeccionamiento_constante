(function (factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: 'Cantidad de establecimientos {0}',                                                        // text when all options are visible / false for no info text
      ...
      btnClass: 'btn-duallistbox',                                                  // sets the button style class for all the buttons
