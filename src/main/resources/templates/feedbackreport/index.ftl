...
<div class="container px-3">
    <div class="row" id="panel-search">
        ...
        <div  class="col-md-9 vis-des">
            <div class="row">
                <div class="col-12">
                    <h2>Reportes retroalimentación</h2>
                </div>
            </div>
            <div class="row mt-4">
        ...
        <div  class="col-md-12 vis-des" >
            <div class="row ">
                ...
                <div class="col-md-12 mt-3">
                    <h3 class="float-left">Reporte retroalimentación</h3>
                </div>
...
<script type="text/javascript" src="${context}/locals/js/feedbackreport/came.feedbackreport.js"></script>
[/@main_page]