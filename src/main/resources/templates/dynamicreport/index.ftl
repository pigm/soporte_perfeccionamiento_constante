    ...
    <div class="row" id="panel-search">
        ...
        <div class="col-md-9 vis-des">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-3">
                    <label for="">&nbsp;</label> <br>
                    <a id="find-dynamic" href="#" class="btn btn-primary btn-sm float-right px-4">
        ...
        <div class="col-md-12 vis-des">
            <div class="row ">
                ...
                <div class="col-6 mt-2">
                    Resultado de la búsqueda (<strong id="count-dynamic"></strong> reportes)
                </div>
                ...
                <div class="col-12 mt-1 table-responsive">
                    <div class=" table-responsive ">
                        <table id="table-dynamic" class="table mine table-hover table-bordered">
                            <thead>
                                <tr>
                                    <th scope="col">RBD</th>
                                    ...
                                    <th scope="col">Supervisor&nbsp;directa</th>
                                    <th scope="col">Supervisor&nbsp;red</th>
                                    <th scope="col">Nombre&nbsp;de&nbsp;la&nbsp;red</th>
                                    <th scope="col">Sesiones&nbsp;programadas&nbsp;directa</th>
                                    <th scope="col">Sesiones&nbsp;programadas&nbsp;red</th>
                                    <th scope="col">Sesiones&nbsp;realizadas&nbsp;directa</th>
                                    <th scope="col">Sesiones&nbsp;realizadas&nbsp;red</th>
                                </tr>
                            </thead>
