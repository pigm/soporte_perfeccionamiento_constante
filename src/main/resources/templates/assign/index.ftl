        ...
        <div class="col-md-9 vis-des">
            ...
            <div class="row mt-4">
                <div class="col-6 text-center">
                    <span style="font-size: 50px" id="supervisoresAsignacionMaxima">${assing.supervisores}</span>
                    <a href="#" class="supervisor" data-placement="top"
                        title='Máximo de supervisores' data-content=''><svg
                ...
                <div class="col-6 text-center">
                    <span style="font-size: 50px" id="focoAsignacionMaxima">${assing.foco}</span>
                    <a href="#" class="foco"
                        title='Máximo de foco'
                        data-content=''>
                    ...
                    <p>Cantidad máxima de focos que pueden trabajar de forma paralela con un establecimiento o red; una vez terminado cada uno de ellos se podrá reemplazar por un nuevo foco</p>
                </div>
            </div>
        </div>       
    </div>
